...
<link href="/hiapt/resources/css/bootstrap.css"
	rel="stylesheet">
<link href="/hiapt/resources/css/jquery-ui.min.css"
	rel="stylesheet">
<link
...
<link href="/hiapt/resources/fullcalendar/fullcalendar.css"
	rel="stylesheet">
...
<body>
			...
			<div id="sidebar-left" class="col-xs-2 col-sm-2">
				<ul class="nav main-menu">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-envelope-o"></i> <span class="hidden-xs">메일(직원)</span>
					</a>
						<ul class="dropdown-menu">
							<li><a class="ajax-link"
								href="/hiapt/views/employee/mail/allmail.jsp">전체메일함</a></li>
					...
					<!--인사정보 시작 -->
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-desktop"></i> <span class="hidden-xs">인사정보</span>
					</a>
						<ul class="dropdown-menu">
							<li><a class="ajax-link"
								 href="/hiapt/views/employee/member/empList.jsp"> <span
									class="hidden-xs">직원조회</span>
							</a></li>
							<li><a class="ajax-link"
								href="/hiapt/views/employee/member/empenroll.html">직원등록</a></li>
						</ul></li>
					<!-- 인사정보 끝 -->
					<!-- 서브메뉴 끝 -->
					<!-- ================================================================================= -->
					...
					<!--전자결재 시작 -->
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-edit (alias)"></i> <span class="hidden-xs">전자결재</span>
					</a>
						<ul class="dropdown-menu">
							...
							<li><a class="ajax-link" href="/hiapt/dlist"><span
									...
									<li><a class="ajax-link" href="/hiapt/dstandby">
										<span class="hidden-xs">전자결재 대기목록</span>
									</a>
									</li>	
									<li><a class="ajax-link" href="/hiapt/dapproved">
										<span class="hidden-xs">전자결재 승인목록</span>
									</a>
								</li>	
								<li><a class="ajax-link" href="/hiapt/dreturn">
										<span class="hidden-xs">전자결재 반려목록</span>
									</a>
								</li>	
								<li><a class="ajax-link" href="/hiapt/ddefer">
										<span class="hidden-xs">전자결재 보류목록</span>
									</a>
								</li>	
								<li><a class="ajax-link" href="/hiapt/dtemp">
										<span class="hidden-xs">임시보관함</span>
									</a>
								</li>	
							<li><a class="ajax-link"
					...
					<!--공지사항 시작 -->
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-bullhorn"></i> <span class="hidden-xs">공지사항(관리자)</span>
					</a>
						<ul class="dropdown-menu">
							<li><a class="ajax-link" href="/hiapt/views/master/notice/noticeAdminListView.jsp"><span
									class="hidden-xs">관리자 공지사항 목록</span></a></li>
							<li><a class="ajax-link" href="/hiapt/"><span
									class="hidden-xs">공지사항 대기목록</span></a></li>
	...
	<script src="/hiapt/resources/js/jquery-ui.min.js"></script>
