...
<div style="float: right; display: flex;">
	...
	<div id="title">
		<form action="/hiapt/dsearchr.ad" method="get" id="searchform">
	...
	<div id="writer">
		<form action="/hiapt/dsearchr.ad" method="get" id="searchform2">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
	...
	<div id="date">
		<form action="/hiapt/dsearchr.ad" method="get" id="searchform3">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
	...
	<div id="formtype">
		<form action="/hiapt/dsearchr.ad" method="get" id="searchform4">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
				...
				<div class="paging_simple_numbers">
					<ul class="pagination" style="justify-content: center;">
						<li class="paginate_button page-item previous"
							...
							<a href="/hiapt/dreturn.ad?page=1" aria-controls="dataTable"
						...
						<li class="paginate_button page-item active back"
							id="dataTable_previous">
							<a href="/hiapt/dreturn.ad?page=<%=beginPage - 10%>"
						...
						<a href="/hiapt/dreturn.ad?page<%=p%>"
						...
						%>
						<li class="paginate_button page-item next" id="dataTable_next">
						<a href="/hiapt/dreturn.ad?page=<%=maxPage%>"
						...
						%>
						<li class="paginate_button page-item next" id="dataTable_next">
						<a href="/hiapt/dreturn.ad?page<%=endPage + 10%>"
		...
		<div class="col-sm-12">
				<div class="paging_simple_numbers">
					<ul class="pagination" style="justify-content: center;">
						<li class="paginate_button page-item previous"
							id="dataTable_previous">
							<a href="/hiapt/dsearchr.ad?empno=<%= emp.getEmpNo() %>&search=<%=search %>&keyword=<%= keyword%>&page=1" aria-controls="dataTable"
							data-dt-idx="0" tabindex="0" class="page-link">&lsaquo;</a></li>
						<%
							if ((beginPage - 10) < 1) {
						%>
						...
						<li class="paginate_button page-item active back"
							id="dataTable_previous">
							<a href="/hiapt/dsearchr.ad?empno=<%= emp.getEmpNo() %>&page=<%=beginPage - 10%>"
							aria-controls="dataTable" data-dt-idx="<%=beginPage - 10%>"
							tabindex="0" class="page-link">&lsaquo;&lsaquo;</a></li>
						<%
							}
						...
						%>
						<li class="paginate_button page-item active next">
						<a href="/hiapt/dsearchr.ad?empno=<%= emp.getEmpNo() %>&search=<%=search %>&keyword=<%= keyword%>&page=<%=p%>"
							aria-controls="dataTable" data-dt-idx="<%=p%>" tabindex="0"
							class="page-link"><%=p%></a></li>
						<%
							} else {
						...
						%>
						<li class="paginate_button page-item next" id="dataTable_next">
						<a href="/hiapt/dsearchr.ad?empno=<%= emp.getEmpNo() %>&search=<%=search %>&keyword=<%= keyword%>&page=<%=maxPage%>"
							aria-controls="dataTable" data-dt-idx="<%=maxPage%>" tabindex="0"
							class="page-link">&rsaquo;&rsaquo;</a></li>
						<%
							} else {
						%>
						<li class="paginate_button page-item next" id="dataTable_next">
						<a href="/hiapt/dsearchr.ad?empno=<%= emp.getEmpNo() %>&search=<%=search %>&keyword=<%= keyword%>&page=<%=endPage + 10%>"
							aria-controls="dataTable" data-dt-idx="<%=endPage + 10%>"
							tabindex="0" class="page-link">&rsaquo;&rsaquo;</a></li>
						<%
							}
