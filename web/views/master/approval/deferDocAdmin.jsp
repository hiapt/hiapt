				...
				<div class="paging_simple_numbers">
					<ul class="pagination" style="justify-content: center;">
						<li class="paginate_button page-item previous"
							...
							<a href="/hiapt/ddefer.ad?page=1" aria-controls="dataTable"
						...
						<li class="paginate_button page-item active back"
							id="dataTable_previous">
							<a href="/hiapt/ddefer.ad?page=<%=beginPage - 10%>"
						...
						%>
						<li class="paginate_button page-item next" id="dataTable_next">
						<a href="/hiapt/ddefer.ad?page=<%=maxPage%>"
						...
						%>
						<li class="paginate_button page-item next" id="dataTable_next">
						<a href="/hiapt/ddefer.ad?page<%=endPage + 10%>"
