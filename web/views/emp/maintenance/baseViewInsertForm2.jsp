						...
						<div class="card-body">
							...
							<div class="card-title" style="float: right;">
								<button onclick="callFunction();"
									class="btn btn-sm btn-warning shadow-sm">관리비등록</button>
								&nbsp; <br>
							</div>
							<br>
							<br>
							...
							<div class="card-title" style="float: right;">
								<form action="/hiapt/bviin" method="post" class="form">
 ...
 var fullcount = 1;
	...
	$(document).on(	"click", "button[name=addRow]",	function(){
		...
		if(count > fullcount){
			...
			+ '<td style="padding-right:0;"><input type="number" class="form-control2 input-sm" name="imposeCount" id="imposeCount" value="" placeholder="마감횟수" min="0"></td>'
		...
		$.ajax({
			 ...
			 success : function(data){
				 ...
				 for(var i in json.list){
					 values += '<tr class="data">'
						+ '<td><div class="checkBox"><label class="check"> '
						+ '<input type="checkbox" class="custom-control-input" name="checkRow" value="' + json.list[i].merchantUid 
						+ '" id="customCheck"><span class="checkmark" ></span></label></td>'
