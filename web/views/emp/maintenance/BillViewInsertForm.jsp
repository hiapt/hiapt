...
<form action="/hiapt/biin" method="post" onclick="return validation();" id="form">
	...
	<table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      ...
                      <th>상태</th>
                      <th colspan="2"><input type="text" name="impose_status" ></th>
                    </tr>
                    <tr>
                      <th>부과년월</th>
                      <th><input type="date" name="bill_year_month" ></th>
                      <th>마감횟수</th>
                      <th colspan="2"><input type="text" name="impose_count" readyonly></th>
                    </tr>
                    <tr>
                      <th>산출기간 시작일</th>
                      <th><input type="date" name="calculate_start_day" ></th>
                      <th>산출기간 종료일</th>
                      <th colspan="2"><input type="date" name="calculate_end_day" ></th>
                    </tr>
                    <tr>
                      <th>납부마감일</th>
                      <th><input type="date" name="cutoff_date" ></th>
                      <th>부과마감일</th>
                      <th colspan="2"><input type="date" name="impose_end_date" ></th>
                    </tr>
                  </thead>
                   <tbody>
                    <tr>
                    ...
                    <tr>
                    	...
                    	<th>출력의뢰일</th>
                    	<td colspan="2"><input type="date" name="accept_date" ></td>
                    </tr>
