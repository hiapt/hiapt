...
<table>
	<tr>
		<th>받는사람</th>
		<td><input type="text" id="recipient" name="recipient" value="<%= mailm.getEmpEmail() %>"></td>
		<td><button class="btn btn-primary btn-sm shadow-sm">주소록</button></td>
	</tr>
	<tr>
		<th>제목</th>
		<td colspan="2"><input type="text" id="title" name="title" value="RE : <%= mailm.getMailTitle() %>"></td>
	</tr>
	<tr>
		<th>파일첨부</th>
	...
	<div
		...
		<textarea name="doccontent" id="smarteditor" rows="10" cols="100"
			style="width: 897px; height: 400px;" required="required">
			<p>-----Original Message-----<br>
			From: <%= mailm.getEmpEmail() %><br>
			To: <%= mailm.getRecipient() %><br>
			Sent: <%= mailm.getMailTitle() %><br>
			Subject: <%= mailm.getMailTitle() %><br>
			</p>
			<%= mailm.getMailContents() %>
		</textarea>
	</div>
	</th>
	</tr>
