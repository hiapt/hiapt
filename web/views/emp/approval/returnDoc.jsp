...
<div style="float: right; display: flex;">
	...
	<div id="title">
		<form action="/hiapt/dsearchr" method="get" id="searchform">
	...
	<div id="writer">
		<form action="/hiapt/dsearchr" method="get" id="searchform2">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
	...
	<div id="date">
		<form action="/hiapt/dsearchr" method="get" id="searchform3">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
	...
	<div id="formtype">
		<form action="/hiapt/dsearchr" method="get" id="searchform4">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
				...
				<div class="paging_simple_numbers">
					<ul class="pagination" style="justify-content: center;">
						<li class="paginate_button page-item previous"
							...
							<a href="/hiapt/dreturn?empno=<%= emp.getEmpNo() %>&page=1" aria-controls="dataTable"
						...
						<li class="paginate_button page-item active back"
							id="dataTable_previous">
							<a href="/hiapt/dreturn?empno=<%= emp.getEmpNo() %>&page=<%=beginPage - 10%>"
						...
						<a href="/hiapt/dreturn?empno=<%= emp.getEmpNo() %>&page<%=p%>"
						...
						%>
						<li class="paginate_button page-item next" id="dataTable_next">
						<a href="/hiapt/dreturn?empno=<%= emp.getEmpNo() %>&page=<%=maxPage%>"
						...
						%>
						<li class="paginate_button page-item next" id="dataTable_next">
						<a href="/hiapt/dreturn?empno=<%= emp.getEmpNo() %>&page<%=endPage + 10%>"
