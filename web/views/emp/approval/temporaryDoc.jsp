...
<div style="float: right; display: flex;">
	...
	<div id="title">
		<form action="/hiapt/dsearcht" method="get" id="searchform">
	...
	<div id="writer">
		<form action="/hiapt/dsearcht" method="get" id="searchform2">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
	...
	<div id="date">
		<form action="/hiapt/dsearcht" method="get" id="searchform3">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
	...
	<div id="formtype">
		<form action="/hiapt/dsearcht" method="get" id="searchform4">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
	...
	<div class="paging_simple_numbers">
		<ul class="pagination" style="justify-content: center;">
			<li class="paginate_button page-item previous"
				...
				href="/hiapt/dtemp?empno=S001&page=1" aria-controls="dataTable"
			...
			<li class="paginate_button page-item active back"
				id="dataTable_previous"><a
				href="/hiapt/dtemp?empno=S001&page=<%=beginPage - 10%>"
			...
			<li class="paginate_button page-item active next"><a
				href="/hiapt/dtemp?empno=S001&page<%=p%>" aria-controls="dataTable"
				data-dt-idx="<%=p%>" tabindex="0" class="page-link"><%=p%></a></li>
			<%
				} else {
			%>
			<li class="paginate_button page-item next" id="dataTable_next">
				<a href="/hiapt/dtemp?empno=S001&page=<%=p%>"
			...
			%>
			<li class="paginate_button page-item next" id="dataTable_next">
				<a href="/hiapt/dtemp?empno=S001&page=<%=maxPage%>"
				aria-controls="dataTable" data-dt-idx="<%=maxPage%>" tabindex="0"
				class="page-link">&rsaquo;&rsaquo;</a>
			</li>
			<%
				} else {
			%>
			<li class="paginate_button page-item next" id="dataTable_next">
				<a href="/hiapt/dtemp?empno=S001&page<%=endPage + 10%>"
				aria-controls="dataTable" data-dt-idx="<%=endPage + 10%>"
				tabindex="0" class="page-link">&rsaquo;&rsaquo;</a>
			</li>
			<%
				}
			%>
