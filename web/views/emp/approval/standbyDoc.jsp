...
<div style="float: right; display: flex;">
	...
	<div id="title">
		<form action="/hiapt/dsearchst" method="get" id="searchform">
	...
	<div id="writer">
		<form action="/hiapt/dsearchst" method="get" id="searchform2">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
	...
	<div id="date">
		<form action="/hiapt/dsearchst" method="get" id="searchform3">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
	...
	<div id="formtype">
		<form action="/hiapt/dsearchst" method="get" id="searchform4">
			<input type="hidden" name="empno" value="<%=emp.getEmpNo()%>">
