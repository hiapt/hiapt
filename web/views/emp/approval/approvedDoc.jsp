...
<h4>승인 문서 : <%= list.size() %>개 </h4>
<table class="table table-bordered dataTable" style="text-align: center;">
					<thead>
						<tr>
							<th width="10">
							<div class="checkbox" style="margin:0px; margin-left: 10px;">
							<label class="btn btn-primary btn-circle btn-sm">
								<input type="checkbox" class="btn btn-primary btn-circle btn-sm">
	...
	<input type="button" value="이동" class="btn btn-primary btn-icon-split" style="padding:10px 18px;">
	</div>
</form>
