...
COMMENT ON COLUMN payment.card_num IS '카드번호';
...
COMMENT ON COLUMN payment.payment_day IS '결제일';

-- INSERT PAYMENT

INSERT INTO PAYMENT VALUES(
'10000000000001', DEFAULT, 152560, '1234123412341234', '가상계좌', '전로하', '010-8001-6812', 'dd55555bb@gmail.com', default
);

INSERT INTO PAYMENT VALUES(
'10000000000002', DEFAULT, 141490, '1234123412341234', '간편결제', '전로하', '010-8001-6812', 'dd55555bb@gmail.com', default
);

INSERT INTO PAYMENT VALUES(
'10000000000003', DEFAULT, 168060, '1234123412341234', '가상계좌', '허용순', '010-2685-4111', 'horse4797@naver.com', default
);

INSERT INTO PAYMENT VALUES(
'10000000000004', DEFAULT, 151930, '1234123412341234', '카드결제', '전로하', '010-8001-6812', 'dd55555bb@gmail.com', default
);

INSERT INTO PAYMENT VALUES(
'10000000000005', DEFAULT, 152560, '1234123412341234', '카드결제', '전로하', '010-8001-6812', 'dd55555bb@gmail.com', default
);

INSERT INTO PAYMENT VALUES(
'10000000000006', DEFAULT, 152560, '1234123412341234', '간편결제', '전로하', '010-8001-6812', 'dd55555bb@gmail.com', default
);

INSERT INTO PAYMENT VALUES(
'10000000000007', DEFAULT, 185340, '1234123412341234', '간편결제', '전로하', '010-8001-6812', 'dd55555bb@gmail.com', default
);

INSERT INTO PAYMENT VALUES(
'10000000000008', DEFAULT, 196660, '1234123412341234', '카드수기결제','전로하', '010-8001-6812', 'dd55555bb@gmail.com',default
);

INSERT INTO PAYMENT VALUES(
'10000000000009', DEFAULT, 270690, '1234123412341234', '카드결제','전로하', '010-8001-6812', 'dd55555bb@gmail.com', default
);

INSERT INTO PAYMENT VALUES(
'10000000000010', DEFAULT, 270690, '1234123412341234', '가상계좌', '전로하', '010-8001-6812', 'dd55555bb@gmail.com',default
);

INSERT INTO PAYMENT VALUES(
'10000000000011', DEFAULT, 206511, '1234123412341234', '카드결제', '전로하', '010-8001-6812', 'dd55555bb@gmail.com',default
);

INSERT INTO PAYMENT VALUES(
'10000000000012', DEFAULT, 195230, '1234123412341234', '실시간계좌이체', '전로하', '010-8001-6812', 'dd55555bb@gmail.com',default
);

INSERT INTO PAYMENT VALUES(
'10000000000013', DEFAULT, 149400, '1234123412341234', '카드결제','전로하', '010-8001-6812', 'dd55555bb@gmail.com',default
);

INSERT INTO PAYMENT VALUES(
'10000000000014', DEFAULT, 149400, '1234123412341234', '카드결제', '전로하', '010-8001-6812', 'dd55555bb@gmail.com',default
);

INSERT INTO PAYMENT VALUES(
'10000000000015', DEFAULT, 222740, '1234123412341234', '간편결제', '전로하', '010-8001-6812', 'dd55555bb@gmail.com',default
);
...
COMMENT ON COLUMN RECEIPT.PG IS '카카오페이지';
COMMENT ON COLUMN receipt.amount IS '결제금액';
COMMENT ON COLUMN receipt.paid_amount IS '결제한금액';
COMMENT ON COLUMN receipt.pai_date IS '결제승인시각';
...
COMMENT ON COLUMN RECEIPT.BUYER_ADDR IS '결제자주소';
COMMENT ON COLUMN RECEIPT.BUYER_postcode IS '우편번호';
...
COMMENT ON COLUMN impose_VIEW_aptuser.USERID IS '동/호';
COMMENT ON COLUMN impose_VIEW_aptuser.USERNAME IS '세대주명';
comment on column impose_VIEW_aptuser.USERPHONE is '전화번호';
