...
/**
 * Servlet implementation class DraftTempSearchServlet
 */
@WebServlet("/dsearcht")
public class DraftTempSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DraftTempSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 제목 검색, 작성자 검색, 작성날짜 검색, 문서형식 검색 기능
				...
				case "title":
					...
					if (list.size() > 0) {
						view = request.getRequestDispatcher("views/emp/approval/temporaryDoc.jsp");
