...
/**
 * Servlet implementation class DrafteDeferSearchAdminServlet
 */
@WebServlet("/dsearchd.ad")
public class DraftDeferSearchAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DraftDeferSearchAdminServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 제목 검색, 작성자 검색, 작성날짜 검색, 문서형식 검색 기능
				...
				case "title":
					...
					if (list.size() > 0) {
						view = request.getRequestDispatcher("views/master/approval/deferDocAdmin.jsp");
