...
/**
 * Servlet implementation class DraftReturnSearchAdminServlet
 */
@WebServlet("/dsearchr.ad")
public class DraftReturnSearchAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DraftReturnSearchAdminServlet() {
        super();
