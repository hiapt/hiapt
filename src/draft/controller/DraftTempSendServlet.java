...
/**
 * Servlet implementation class DraftTempSendServlet
 */
@WebServlet("/dtsend")
public class DraftTempSendServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DraftTempSendServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new DraftService().tempSave(draft);
		
		if(result > 0) {
			response.sendRedirect("/hiapt/index.jsp?#/hiapt/dtemp");
		} else {
