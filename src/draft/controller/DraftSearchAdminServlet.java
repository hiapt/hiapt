...
public class DraftSearchAdminServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "title":
			...
			int listCount = dservice.getSearchCountTAdmin(draftTitle); // 테이블의 전체 목록 갯수 조회
			// 총 페이지 수 계산
			...
			list = dservice.draftTitleSearchAdmin(draftTitle, startRow, endRow);
		...
		case "writer":
			...
			int listCount2 = dservice.getSearchCountWAdmin(draftWriter); // 테이블의 전체 목록 갯수 조회
			// 총 페이지 수 계산
			...
			list = dservice.draftWriterSearchAdmin(draftWriter, startRow, endRow);
		...
		case "date":
			...
			int listCount3 = dservice.getSearchCountDAdmin(Date.valueOf(beginDate), Date.valueOf(toDate)); // 테이블의 전체 목록 갯수 조회
			// 총 페이지 수 계산
		...
		case "formtype":
			...
			int listCount4 = dservice.getSearchCountFAdmin(draftFormname); // 테이블의 전체 목록 갯수 조회
			// 총 페이지 수 계산
			...
			list = dservice.draftFormtypeSearchAdmin(draftFormname, startRow, endRow);
