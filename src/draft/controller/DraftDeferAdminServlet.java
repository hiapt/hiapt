...
/**
 * Servlet implementation class DraftDeferAdminServlet
 */
@WebServlet("/ddefer.ad")
public class DraftDeferAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DraftDeferAdminServlet() {
        super();
