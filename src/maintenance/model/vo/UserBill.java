...
public class UserBill implements java.io.Serializable {
	...
	public UserBill(long merchantUid, String userId, String userName, Date billYearMonth, Date calculateStartDay,
	...
	public String toString() {
		return "UserBill [merchantUid=" + merchantUid + ", userId=" + userId + ", userName=" + userName
				+ ", billYearMonth=" + billYearMonth + ", calculateStartDay=" + calculateStartDay + ", calculateEndDay="
				+ calculateEndDay + ", imposeEndDay=" + imposeEndDay + ", acceptDate=" + acceptDate + ", cutoffDate="
				+ cutoffDate + ", imposeStatus=" + imposeStatus + ", imposeCount=" + imposeCount + ", imposeFinish="
				+ imposeFinish + ", generalCost=" + generalCost + ", guardCost=" + guardCost + ", cleanCost="
				+ cleanCost + ", disinfectCost=" + disinfectCost + ", elevatorCost=" + elevatorCost + ", repairCost="
				+ repairCost + ", commission=" + commission + ", fireInsuranceCost=" + fireInsuranceCost
				+ ", electricCost=" + electricCost + ", tvCost=" + tvCost + ", waterCost=" + waterCost
				+ ", heatingCost=" + heatingCost + ", hwaterCost=" + hwaterCost + ", allElectricCost=" + allElectricCost
				+ ", allWaterCost=" + allWaterCost + ", electricUsage=" + electricUsage + ", waterUsage=" + waterUsage
				+ ", heatingUsage=" + heatingUsage + ", hwaterUsage=" + hwaterUsage + ", arrears=" + arrears + ", etc="
				+ etc + ", vbankNum=" + vbankNum + ", amount=" + amount + ", beforeAmount=" + beforeAmount
				+ ", afterAmount=" + afterAmount + ", arrearsFine=" + arrearsFine + "]";
	}
