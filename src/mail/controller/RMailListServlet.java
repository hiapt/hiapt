...
/**
 * Servlet implementation class RMailListServlet
 */
@WebServlet("/rlist")
public class RMailListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RMailListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = mservice.getListCountR(email);		//테이블의 전체 목록 갯수 조회
		//총 페이지 수 계산
