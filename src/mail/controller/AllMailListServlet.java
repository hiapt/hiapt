...
/**
 * Servlet implementation class AllMailListServlet
 */
@WebServlet("/amlist")
public class AllMailListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AllMailListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = mservice.getListCountA(email);		//테이블의 전체 목록 갯수 조회
		//총 페이지 수 계산
		...
		ArrayList<Mailm> list = mservice.selectListA(email, startRow, endRow);
