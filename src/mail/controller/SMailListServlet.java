...
/**
 * Servlet implementation class SMailListServlet
 */
@WebServlet("/smlist")
public class SMailListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SMailListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = mservice.getListCountS(email);		//테이블의 전체 목록 갯수 조회
		//총 페이지 수 계산
