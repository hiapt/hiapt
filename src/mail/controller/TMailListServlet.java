...
/**
 * Servlet implementation class TMailListServlet
 */
@WebServlet("/tmlist")
public class TMailListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TMailListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = mservice.getListCountT(email);		//테이블의 전체 목록 갯수 조회
		//총 페이지 수 계산
