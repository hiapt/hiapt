...
/**
 * Servlet implementation class SelfMailListServlet
 */
@WebServlet("/selfmlist")
public class SelfMailListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelfMailListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = mservice.getListCountSelf(email);		//테이블의 전체 목록 갯수 조회
		//총 페이지 수 계산
